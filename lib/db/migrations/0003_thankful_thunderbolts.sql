...
CREATE TABLE IF NOT EXISTS "Settings" (
	...
	"defaultSearchModel" text,
	"webSearchEnabled" boolean DEFAULT false NOT NULL,
	"statsForNerds" boolean DEFAULT false NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "Settings" ADD CONSTRAINT "Settings_userId_User_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
