...
function PureArtifact({
  ...
  const isOverlay = windowWidth ? windowWidth < 1024 : false;
  ...
  if (!artifact.isVisible && !isOverlay) {
    return (
      <div
  ...
  if (isOverlay) {
    return (
      <motion.div
        ...
        className="fixed inset-0 z-50 flex h-dvh flex-col overflow-hidden bg-sidebar pt-[env(safe-area-inset-top)]"
        data-testid="artifact"
